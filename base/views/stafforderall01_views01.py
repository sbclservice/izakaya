...
class OrderAll01StaffView01(LoginRequiredMixin, ListView):
    model = Order
    template_name = 'pages/order0200.html'
    context_object_name = 'orders0200'
    ...
    def get_context_data(self, **kwargs):
        ...
        filtered_orders = [
            order for order in context['orders0200']
