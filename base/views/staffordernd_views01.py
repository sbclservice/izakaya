...
class OrderndStaffView01(LoginRequiredMixin, ListView):
    model = Order
    template_name = 'pages/ordernd00.html'
    context_object_name = 'ordersnd00'
    ...
    def get_context_data(self, **kwargs):
        ...
        filtered_orders = [
            order for order in context['ordersnd00']
