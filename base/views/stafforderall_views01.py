...
class OrderAllStaffView01(LoginRequiredMixin, ListView):
    model = Order
    template_name = 'pages/order0100.html'
    context_object_name = 'orders0100'
    ...
    def get_context_data(self, **kwargs):
        ...
        filtered_orders = [
            order for order in context['orders0100']
